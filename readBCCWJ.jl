...
Merlin.h5save("/data/kyoshinaga/corpus/jpnTrainDoc.h5",jpnTrainDoc)
Merlin.h5save("/data/kyoshinaga/corpus/jpnValidDoc.h5",jpnValidDoc)
Merlin.h5save("/data/kyoshinaga/corpus/jpnTestDoc.h5",jpnTestDoc)
